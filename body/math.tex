...
\begin{figure}[bth]
    \centering
    \includegraphics[width=0.8\linewidth]{deduction_t}
...
\begin{figure}[bth]
    \centering
    \includegraphics[width=0.8\linewidth]{deduction_n}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{suggestive_contour_definition}
